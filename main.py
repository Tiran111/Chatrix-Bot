...
def setup_handlers(app_instance):
    ...
    from handlers.search import search_profiles, search_by_city, show_next_profile, show_top_users, show_matches, show_likes, handle_top_selection, show_user_profile, handle_like, handle_navigation
    ...
    app_instance.add_handler(MessageHandler(filters.Regex('^🔙 Пошук$'), handle_navigation))
    app_instance.add_handler(MessageHandler(filters.Regex('^🔙 Скасувати$'), handle_navigation))
