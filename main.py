...
async def error_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        # Спроба відправити повідомлення про помилку користувачу
        if update and update.effective_user:
            await update.message.reply_text(
                "❌ Сталася помилка. Спробуйте ще раз або використовуйте /start"
            )
    except Exception as e:
        print(f"❌ Помилка в error_handler: {e}")
...
def main():
    try:
        ...
        try:
            ...
            print(f"❌ Помилка завантаження admin: {e}")
        ...
        try:
            ...
            print("✅ Обробники профілю додані")
        except ImportError as e:
        ...
        try:
            ...
            print("✅ Обробники пошуку додані")
        except ImportError as e:
            print(f"❌ Помилка завантаження пошуку: {e}")
        ...
        # СПРОЩЕНИЙ ЗАПУСК БЕЗ НЕПІДТРИМУВАНИХ ПАРАМЕТРІВ
