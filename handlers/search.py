...
async def search_by_city(update: Update, context: CallbackContext):
    ...
    # Показуємо клавіатуру з популярними містами
    keyboard = [
        ['🏙️ Київ', '🏙️ Львів', '🏙️ Одеса'],
        ['🏙️ Харків', '🏙️ Дніпро', '🏙️ Запоріжжя'],
        ['🏙️ Вінниця', '🏙️ Житомир', '🏙️ Івано-Франківськ'],
        ['🏙️ Кропивницький', '🏙️ Луцьк', '🏙️ Миколаїв'],
        ['🏙️ Полтава', '🏙️ Рівне', '🏙️ Суми'],
        ['🏙️ Тернопіль', '🏙️ Ужгород', '🏙️ Херсон'],
        ['🏙️ Хмельницький', '🏙️ Черкаси', '🏙️ Чернівці'],
        ['🏙️ Чернігів', '✏️ Ввести інше місто'],
        ['🔙 Меню']
    ]
    
    await update.message.reply_text(
        "🏙️ Оберіть місто для пошуку або введіть назву вручну:",
